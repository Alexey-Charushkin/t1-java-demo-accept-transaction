package ru.t1.java.accept_transaction.config;
...
import ru.t1.java.accept_transaction.kafka.MessageDeserializer;
...
public class KafkaConfig<T> {
    ...
    public ConsumerFactory<String, Object> consumerListenerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "ru.t1.java.accept_transaction.model.dto.RequestedTransaction");
